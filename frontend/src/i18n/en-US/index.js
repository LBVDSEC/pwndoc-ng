export default {
    ...
    cvss4: {
        title: 'CVSS v4.0 Base Score',
        additionalMetricsTitle: 'Threat and Environmental Metrics for CVSS 4.0',
        scorePlaceholder: 'Please select metrics',
        ...
        vulnerableSystemImpactMetrics: 'Vulnerable System Impact Metrics',
        vulnerableSystemConfidentiality: 'Confidentiality (VC)',
        vulnerableSystemIntegrity: 'Integrity (VI)',
        vulnerableSystemAvailability: 'Availability (VA)',
        subsequentSystemImpactMetrics: 'Subsequent System Impact Metrics',
        subsequentSystemConfidentiality: 'Confidentiality (SC)',
        subsequentSystemIntegrity: 'Integrity (SI)',
        subsequentSystemAvailability: 'Availability (SA)',
        supplementalMetrics: 'Supplemental Metrics',
        safety: 'Safety (S)',
        automatable: 'Automatable (AU)',
        recovery: 'Recovery (R)',
        valueDensity: 'Value Density (V)',
        vulnerabilityResponseEffort: 'Vulnerability Response Effort (RE)',
        providerUrgency: 'Provider Urgency (U)',
        environmentalModified: 'Environmental (Modified Base Metrics)',
        environmentalRequirements: 'Environmental (Security Requirements)',
        environmentalScore: 'Environmental Score',
        envAttackVector: 'Attack Vector (MAV)',
        envAttackComplexity: 'Attack Complexity (MAC)',
        envAttackRequirements: 'Attack Requirements (MAT)',
        envPrivilegesRequired: 'Privileges Required (MPR)',
        envUserInteraction: 'User Interaction (MUI)',
        envVulnerableSystemConfidentiality: 'Confidentiality (MVC)',
        envVulnerableSystemIntegrity: 'Integrity (MVI)',
        envVulnerableSystemAvailability: 'Availability (MVA)',
        envSubsequentSystemconfidentiality: 'Confidentiality (MSC)',
        envSubsequentSystemIntegrity: 'Integrity (MSI)',
        envSubsequentSystemAvailability: 'Availability (MSA)',
        envConfidentiality: 'Confidentiality (CR)',
        envIntegrity: 'Integrity (IR)',
        envAvailability: 'Availability (AR)',
